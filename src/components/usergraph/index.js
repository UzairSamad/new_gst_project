...
export default function BasicTable() {
  ...
  const renderTable = () => {
    return (
      <TableContainer
        style={{ maxWidth: "1230px", border: "1px solid #e4e4e4" }}
        component={Paper}
      >
  ...
  return (
    <div>
      ...
      >
        <p style={{ fontWeight: "100", fontSize: "15px", color: "#676A6C" }}>
          Select User
        </p>
      </div>
      <div
      ...
      >
        <div id="chartdiv" style={{ width: "47%", height: "500px" }} />
        <div id="chartdivv" style={{ width: "47%", height: "500px" }} />
      </div>
      <div
        style={{
